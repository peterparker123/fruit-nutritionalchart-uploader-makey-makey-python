This python script will upload the image of any object which is connected to the circuit named 'Makey-Makey'. The program can execute in win32 or linux platform.
